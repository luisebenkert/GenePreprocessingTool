...
write.csv(transp_metadata1, file="./GDCdata/2018-03-10_18-20-12/TCGA-UCEC_TCGA-GBM__GeneExpressionQuantification_HTSeq-Counts_metadata.csv")
...
write.csv(transp_sel_meta1, file="./GDCdata/2018-03-10_18-20-12/TCGA-UCEC_TCGA-GBM__GeneExpressionQuantification_HTSeq-Counts_metadata_topfeatures.csv")
matrix1 <- t(assay(transdds1)) #creates the gene expression matrix with genes as rows
write.csv(matrix1, file="./GDCdata/2018-03-10_18-20-12/TCGA-UCEC_TCGA-GBM__GeneExpressionQuantification_HTSeq-Counts.csv")
final_matrix1 <- t(assay(selected_features1)) #creates the gene expression matrix with genes as rows
write.csv(final_matrix1, file="./GDCdata/2018-03-10_18-20-12/TCGA-UCEC_TCGA-GBM__GeneExpressionQuantification_HTSeq-Counts_topfeatures.csv")
})
